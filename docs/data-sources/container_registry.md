...
- `id` (String) The UUID of the registry entity. Exactly one of `id` or `user_defined_alias` must be provided.
- `user_defined_alias` (String) A user-defined friendly name for the registry. Exactly one of `id` or `user_defined_alias` must be provided. The lookup fails if the alias does not match exactly one registry.
