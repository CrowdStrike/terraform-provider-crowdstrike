...
func RegisterSweepers() {
	sweep.Register("crowdstrike_ngsiem_data_connection", sweepNgsiemDataConnection)
}

func sweepNgsiemDataConnection(ctx context.Context, client *client.CrowdStrikeAPISpecification) ([]sweep.Sweepable, error) {
...
func deleteNgsiemDataConnection(ctx context.Context, client *client.CrowdStrikeAPISpecification, id string) error {
