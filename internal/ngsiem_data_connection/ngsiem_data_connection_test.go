...
func TestAccNgsiemDataConnectionResource_basic(t *testing.T) {
	...
	resourceName := "crowdstrike_ngsiem_data_connection.test"
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccNgsiemDataConnectionConfig_basic(rName),
...
func testAccNgsiemDataConnectionConfig_basic(name string) string {
	return fmt.Sprintf(`
