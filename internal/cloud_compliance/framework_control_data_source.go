	...
	resp.Schema = schema.Schema{
		...
		Attributes: map[string]schema.Attribute{
			"control_name": schema.StringAttribute{
				Optional:            true,
				MarkdownDescription: "Name of the control. Examples: `Ensure security contact phone is set`, `Ensure that Azure Defender*`",
			...
			"benchmark": schema.StringAttribute{
				Optional:            true,
				MarkdownDescription: "Name of the compliance benchmark in the framework. Examples: `AWS Foundational Security Best Practices v1.*`, `CIS 1.2.0 GCP`, `CIS 1.8.0 GKE`",
				Validators: []validator.String{
					stringvalidator.ConflictsWith(path.MatchRoot("fql")),
				},
			},
			"requirement": schema.StringAttribute{
				Optional:            true,
				MarkdownDescription: "Requirement of the control(s) within the framework. Examples: `2.*`, `1.1`",
				Validators: []validator.String{
					stringvalidator.ConflictsWith(path.MatchRoot("fql")),
				},
			},
			"section": schema.StringAttribute{
				Optional:            true,
				MarkdownDescription: "Section of the benchmark where the control(s) reside. Examples: `Data Protection`, `Data*`",
				Validators: []validator.String{
					stringvalidator.ConflictsWith(path.MatchRoot("fql")),
				},
			},
			"fql": schema.StringAttribute{
				Optional:            true,
				MarkdownDescription: "Falcon Query Language (FQL) filter for advanced control searches. FQL filter, allowed props: `compliance_control_name`, `compliance_control_authority`, `compliance_control_type`, `compliance_control_section`, `compliance_control_requirement`, `compliance_control_benchmark_name`, `compliance_control_benchmark_version`",
			},
